 ...
 * */
db.collection("travellers").insertMany([
  { id: 0, name: "wang", phone: 123412, bookingTime: new Date() },
  { id: 1, name: "david", phone: 123123, bookingTime: new Date() },
  { id: 2, name: "test", phone: 2133123, bookingTime: new Date() },
]);
